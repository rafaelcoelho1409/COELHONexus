...
# fasthtml 23023→23003, fastmcp 23024→23004.
...
nohup bash -c 'while true; do kubectl port-forward -n coelhonexus svc/coelhonexus-fastmcp 23004:8000; sleep 10; done' > /tmp/pf-fastmcp.log 2>&1 &

echo "Port forwards started:"
echo "  FastAPI:  http://localhost:23000"
echo "  Flower:   http://localhost:23002"
echo "  FastHTML: http://localhost:23003"
echo "  FastMCP:  http://localhost:23004"
