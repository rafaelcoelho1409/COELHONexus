...
nohup bash -c 'while true; do kubectl port-forward -n coelhonexus svc/coelhonexus-web 23001:3000; sleep 10; done' > /tmp/pf-web.log 2>&1 &

echo "Port forwards started:"
echo "  FastAPI: http://localhost:23000"
echo "  Web:     http://localhost:23001"
