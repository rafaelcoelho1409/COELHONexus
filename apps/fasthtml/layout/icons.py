"""Inline SVG icon constants used in page chrome.

Feather-style strokes inherit `currentColor` — no extra asset, theme-
agnostic. Grow this file as new chrome icons land (search, user,
chevrons, etc.)."""
