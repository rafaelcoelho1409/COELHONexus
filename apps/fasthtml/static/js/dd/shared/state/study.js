...
export const studyChapterNavEl  = document.querySelector('#fw-study-chapter-nav');
export const studyProgressFillEl = document.querySelector('#fw-study-progress-fill');
