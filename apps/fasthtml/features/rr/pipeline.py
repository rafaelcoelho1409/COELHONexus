...
_NODES: list[dict] = [
    ...
    dict(key="discovery_openalex",                 phase="discovery",   kind="subagent",
         label="discovery_openalex", sub="OpenAlex"),
