...
@router.post(
    ...
    response_model = schemas.ResetSeenResponse,
    status_code    = 200,
)
async def reset_seen_endpoint(profile_id: str) -> schemas.ResetSeenResponse:
    ...
    try:
        n = await domains.rr.stores.service.reset_seen(profile_id)
    ...
    return schemas.ResetSeenResponse(profile_id=profile_id, deleted=n)
