...
async def dispatch_streaming_totals(
    extract_id: str,
    video_ids: list[str],
    ...
    (see `extract_videos_async`, for early progress feedback while
...
async def extract_videos_async(
    video_ids:             list[str],
    include_transcription: bool,
    ...
    try:
        ...
        videos_meta_map: dict[str, dict[str, Any]] = {
            v["id"]: domain.project_video_meta(v)
        ...
        # return dict and in `dispatch_streaming_totals`'s call, which
        ...
        if extract_id:
            await dispatch_streaming_totals(
...
async def extract_channel_async(
    channel_id:            str,
    max_results:           int,
    include_transcription: bool,
    languages:             list[str] | None,
...
async def extract_playlist_async(
    playlist_id:           str,
    max_results:           int,
    include_transcription: bool,
    languages:             list[str] | None,
