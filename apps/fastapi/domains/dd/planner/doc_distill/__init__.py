...
For corpora ≤80 docs, this node is pass-through (downstream consumes
raw bodies). For 80 < N ≤ 2000, fires parallel LLM calls producing a
...
"""
from .node import doc_distill, load_distillates
