...
def select_versioned_key(slug: str, manifest: str) -> str:
    return f"{params.BLOB_PREFIX}/{slug}/chapter_select/{manifest}.json"


def select_latest_key(slug: str) -> str:
    return f"{params.BLOB_PREFIX}/{slug}/chapter_select-latest.json"


def chapter_plan_versioned_key(slug: str, manifest: str) -> str:
    return f"{params.BLOB_PREFIX}/{slug}/chapters/{manifest}.json"


def chapter_plan_latest_key(slug: str) -> str:
    return f"{params.BLOB_PREFIX}/{slug}/chapter_plan-latest.json"
