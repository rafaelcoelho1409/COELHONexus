...
class CodeRefResolution(BaseModel):
    ...
    `tier` (Ship #96, 2026-05-24):
      - "verbatim":     code substituted byte-exact from vault[hash]
      - "derived":      AI-generated by sawc_derive; AST parses cleanly
      - "hallucinated": missing from vault w/o derived fallback, OR
                        byte-drift on a verbatim ref, OR derived body
                        failed AST parse (audit-passed=False).
    """
    hash:                str
    found_in_vault:      bool
...
class AuditResult(BaseModel):
    ...
    # Ship #96 (2026-05-24) — 3-tier classification counts. Hallucinated
    # blocks block audit_passed.
    n_verbatim:             int = 0
    n_derived:              int = 0
